...
BODY = {
    ...
    '停止位置の秒数をコピー': 'Copy paused time in seconds',
    '停止位置の0.1秒前をコピー': 'Copy 0.1 seconds before', '停止位置をコピー': 'Copy current time', '停止位置の0.1秒後をコピー': 'Copy 0.1 seconds after',
    '−0.1秒': '−0.1s', '＋0.1秒': '+0.1s', '現在': 'Now', 'クリックでコピー': 'Click to copy',
...
UI = {
    ...
    'コピー失敗': 'Copy failed', 'クリックでコピー': 'Click to copy',
